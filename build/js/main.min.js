...
var _stickyHeader = require("./modules/header/sticky-header");
var _employeesSlider = require("./modules/sliders/employees-slider");
var _productsSlider = require("./modules/sliders/products-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _employeesSlider.initsSliderEmployees)();
  (0, _productsSlider.initsSliderProducts)();
...
},{"./modules/form-validate/form":3,"./modules/header/sticky-header":9,"./modules/header/toggle":10,"./modules/modals/init-modals":11,"./modules/sliders/employees-slider":13,"./modules/sliders/products-slider":14,"./utils/ios-vh-fix":17,"./vendor/accordions/init-accordion":20,"./vendor/tabs/init-tabs":21}],2:[function(require,module,exports){
"use strict";
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var StickyHeader = exports.StickyHeader = /*#__PURE__*/function () {
...
var addToggleMenu = exports.addToggleMenu = function addToggleMenu() {
  var OPENED_CLASS = 'is-opened';
  var OPENING_CLASS = 'is-opening';
  var CLOSING_CLASS = 'is-closing';
  var LINK_CLASS = '.nav__link';
  var BUTTON_CLASS = '.header__toggle';
  var root = document.querySelector('.header');
  var toggle = root.querySelector('.toggle');
  var nav = root.querySelector('.header__nav');
  ...
  var isMenu = function isMenu(evt) {
    if (evt.target.closest('.header') && (evt.target.closest('.toggle') || evt.target.closest('.header__nav'))) {
      evt.preventDefault();
    } else {
      closeMenu();
    }
  ...
  var onDocumentOutside = function onDocumentOutside(evt) {
    if (evt.target !== toggle && !toggle.contains(evt.target) && evt.target !== nav && !nav.contains(evt.target)) {
      closeMenu();
    }
  };
...
exports.initsSliderEmployees = void 0;
/* eslint-disable no-new */
var sliderEmployees = document.querySelector('.employees__wrapper');
var buttonNext = document.querySelector('.employees__button--next');
var buttonPrev = document.querySelector('.employees__button--prev');
var initsSliderEmployees = exports.initsSliderEmployees = function initsSliderEmployees() {
  if (sliderEmployees) {
...
exports.initsSliderProducts = void 0;
/* eslint-disable no-new */
var sliders = document.querySelectorAll('.products__list');
var buttonsNext = document.querySelectorAll('.products__button--next');
var buttonsPrev = document.querySelectorAll('.products__button--prev');
var initsSliderProducts = exports.initsSliderProducts = function initsSliderProducts() {
  sliders.forEach(function (slider, index) {
    var buttonNext = buttonsNext[index];
    var buttonPrev = buttonsPrev[index];
    if (slider) {
      // eslint-disable-next-line no-undef
      new Swiper(slider, {
        navigation: {
