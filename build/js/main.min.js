...
},{"./modules/form-validate/form":3,"./modules/header/sticky-header":9,"./modules/header/toggle":10,"./modules/modals/init-modals":11,"./modules/sliders/employees-slider":13,"./modules/sliders/products-slider":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
/* eslint-disable no-new */
var sliderProducts = document.querySelector('.products__list');
var buttonNext = document.querySelector('.products__button--next');
var buttonPrev = document.querySelector('.products__button--prev');
